                ...
                <table className="w-full border-collapse">
                  ...
                  <tbody>
                    {filteredParts.map((part) => (
                      <tr key={part.partnumber} className="border-b border-border/50 hover:bg-muted/30">
                        <td className="p-2">
                          <Checkbox
                            checked={selectedParts.has(part.partnumber)}
                            onCheckedChange={() => toggleSelectPart(part.partnumber)}
                          />
                        </td>
                        {Array.from(visibleColumns).map(columnKey => (
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => setNewFieldConfig(prev => ({ ...prev, required: checked }))}
                      />
